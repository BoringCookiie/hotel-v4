...
import EmployeeTasks from './EmployeeTasks'; // Adjust path if needed
    ...
    <div style={{ display: 'flex' }}>
      ...
      <div style={styles.sidebar}>
        ...
        <ul style={styles.sidebarList}>
          ...
          <li style={styles.sidebarItem} onClick={goToEmployeeTasks}>Employees Tasks</li> {/* New Button */}
        </ul>
      ...
      <div style={styles.mainContent}>
        ...
        <Outlet /> {/* This is where the EmployeeTasks component will render */}
      </div>
    </div>
  );
};
